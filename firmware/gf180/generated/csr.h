...
static inline uint32_t ctrl_reset_read(void) { return csr_read_simple(CSR_BASE + 0x0L); }

static inline void ctrl_reset_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x0L); }
...
static inline uint32_t ctrl_scratch_read(void) { return csr_read_simple(CSR_BASE + 0x4L); }

static inline void ctrl_scratch_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x4L); }

#define CSR_CTRL_BUS_ERRORS_ADDR (CSR_BASE + 0x8L)
#define CSR_CTRL_BUS_ERRORS_SIZE 1

static inline uint32_t ctrl_bus_errors_read(void) { return csr_read_simple(CSR_BASE + 0x8L); }
...
static inline uint32_t debug_mode_out_read(void) { return csr_read_simple(CSR_BASE + 0x800L); }

static inline void debug_mode_out_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x800L); }
...
static inline uint32_t debug_oeb_out_read(void) { return csr_read_simple(CSR_BASE + 0x1000L); }

static inline void debug_oeb_out_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x1000L); }
...
static inline uint32_t flash_core_mmap_dummy_bits_read(void) { return csr_read_simple(CSR_BASE + 0x1800L); }

static inline void flash_core_mmap_dummy_bits_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x1800L); }

#define CSR_FLASH_CORE_MASTER_CS_ADDR (CSR_BASE + 0x1804L)
#define CSR_FLASH_CORE_MASTER_CS_SIZE 1

static inline uint32_t flash_core_master_cs_read(void) { return csr_read_simple(CSR_BASE + 0x1804L); }

static inline void flash_core_master_cs_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x1804L); }

#define CSR_FLASH_CORE_MASTER_PHYCONFIG_ADDR (CSR_BASE + 0x1808L)
#define CSR_FLASH_CORE_MASTER_PHYCONFIG_SIZE 1

static inline uint32_t flash_core_master_phyconfig_read(void) { return csr_read_simple(CSR_BASE + 0x1808L); }

static inline void flash_core_master_phyconfig_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x1808L); }
...
static inline uint32_t flash_core_master_rxtx_read(void) { return csr_read_simple(CSR_BASE + 0x180cL); }

static inline void flash_core_master_rxtx_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x180cL); }

#define CSR_FLASH_CORE_MASTER_STATUS_ADDR (CSR_BASE + 0x1810L)
#define CSR_FLASH_CORE_MASTER_STATUS_SIZE 1

static inline uint32_t flash_core_master_status_read(void) { return csr_read_simple(CSR_BASE + 0x1810L); }
...
static inline uint32_t flash_phy_clk_divisor_read(void) { return csr_read_simple(CSR_BASE + 0x2000L); }

static inline void flash_phy_clk_divisor_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x2000L); }
...
static inline uint32_t gpio_mode1_read(void) { return csr_read_simple(CSR_BASE + 0x2800L); }

static inline void gpio_mode1_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x2800L); }

#define CSR_GPIO_MODE0_ADDR (CSR_BASE + 0x2804L)
#define CSR_GPIO_MODE0_SIZE 1

static inline uint32_t gpio_mode0_read(void) { return csr_read_simple(CSR_BASE + 0x2804L); }

static inline void gpio_mode0_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x2804L); }

#define CSR_GPIO_IEN_ADDR (CSR_BASE + 0x2808L)
#define CSR_GPIO_IEN_SIZE 1

static inline uint32_t gpio_ien_read(void) { return csr_read_simple(CSR_BASE + 0x2808L); }

static inline void gpio_ien_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x2808L); }

#define CSR_GPIO_OE_ADDR (CSR_BASE + 0x280cL)
#define CSR_GPIO_OE_SIZE 1

static inline uint32_t gpio_oe_read(void) { return csr_read_simple(CSR_BASE + 0x280cL); }

static inline void gpio_oe_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x280cL); }

#define CSR_GPIO_IN_ADDR (CSR_BASE + 0x2810L)
#define CSR_GPIO_IN_SIZE 1

static inline uint32_t gpio_in_read(void) { return csr_read_simple(CSR_BASE + 0x2810L); }

#define CSR_GPIO_OUT_ADDR (CSR_BASE + 0x2814L)
#define CSR_GPIO_OUT_SIZE 1

static inline uint32_t gpio_out_read(void) { return csr_read_simple(CSR_BASE + 0x2814L); }

static inline void gpio_out_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x2814L); }
...
static inline uint32_t mprj_wb_iena_out_read(void) { return csr_read_simple(CSR_BASE + 0x3800L); }

static inline void mprj_wb_iena_out_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x3800L); }
...
static inline uint32_t spi_enabled_out_read(void) { return csr_read_simple(CSR_BASE + 0x4000L); }

static inline void spi_enabled_out_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x4000L); }
...
static inline uint32_t spi_master_control_read(void) { return csr_read_simple(CSR_BASE + 0x4800L); }

static inline void spi_master_control_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x4800L); }
...
static inline uint32_t spi_master_status_read(void) { return csr_read_simple(CSR_BASE + 0x4804L); }
...
static inline uint32_t spi_master_mosi_read(void) { return csr_read_simple(CSR_BASE + 0x4808L); }

static inline void spi_master_mosi_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x4808L); }

#define CSR_SPI_MASTER_MISO_ADDR (CSR_BASE + 0x480cL)
#define CSR_SPI_MASTER_MISO_SIZE 1

static inline uint32_t spi_master_miso_read(void) { return csr_read_simple(CSR_BASE + 0x480cL); }

#define CSR_SPI_MASTER_CS_ADDR (CSR_BASE + 0x4810L)
#define CSR_SPI_MASTER_CS_SIZE 1

static inline uint32_t spi_master_cs_read(void) { return csr_read_simple(CSR_BASE + 0x4810L); }

static inline void spi_master_cs_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x4810L); }
...
static inline uint32_t spi_master_loopback_read(void) { return csr_read_simple(CSR_BASE + 0x4814L); }

static inline void spi_master_loopback_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x4814L); }
...
static inline uint32_t spi_master_clk_divider_read(void) { return csr_read_simple(CSR_BASE + 0x4818L); }

static inline void spi_master_clk_divider_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x4818L); }
...
static inline uint32_t timer0_load_read(void) { return csr_read_simple(CSR_BASE + 0x5000L); }

static inline void timer0_load_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x5000L); }

#define CSR_TIMER0_RELOAD_ADDR (CSR_BASE + 0x5004L)
#define CSR_TIMER0_RELOAD_SIZE 1

static inline uint32_t timer0_reload_read(void) { return csr_read_simple(CSR_BASE + 0x5004L); }

static inline void timer0_reload_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x5004L); }

#define CSR_TIMER0_EN_ADDR (CSR_BASE + 0x5008L)
#define CSR_TIMER0_EN_SIZE 1

static inline uint32_t timer0_en_read(void) { return csr_read_simple(CSR_BASE + 0x5008L); }

static inline void timer0_en_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x5008L); }

#define CSR_TIMER0_UPDATE_VALUE_ADDR (CSR_BASE + 0x500cL)
#define CSR_TIMER0_UPDATE_VALUE_SIZE 1

static inline uint32_t timer0_update_value_read(void) { return csr_read_simple(CSR_BASE + 0x500cL); }

static inline void timer0_update_value_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x500cL); }

#define CSR_TIMER0_VALUE_ADDR (CSR_BASE + 0x5010L)
#define CSR_TIMER0_VALUE_SIZE 1

static inline uint32_t timer0_value_read(void) { return csr_read_simple(CSR_BASE + 0x5010L); }

#define CSR_TIMER0_EV_STATUS_ADDR (CSR_BASE + 0x5014L)
#define CSR_TIMER0_EV_STATUS_SIZE 1

static inline uint32_t timer0_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x5014L); }
...
static inline uint32_t timer0_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x5018L); }
...
static inline uint32_t timer0_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x501cL); }

static inline void timer0_ev_enable_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x501cL); }
...
static inline uint32_t uart_rxtx_read(void) { return csr_read_simple(CSR_BASE + 0x5800L); }

static inline void uart_rxtx_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x5800L); }

#define CSR_UART_TXFULL_ADDR (CSR_BASE + 0x5804L)
#define CSR_UART_TXFULL_SIZE 1

static inline uint32_t uart_txfull_read(void) { return csr_read_simple(CSR_BASE + 0x5804L); }

#define CSR_UART_RXEMPTY_ADDR (CSR_BASE + 0x5808L)
#define CSR_UART_RXEMPTY_SIZE 1

static inline uint32_t uart_rxempty_read(void) { return csr_read_simple(CSR_BASE + 0x5808L); }

#define CSR_UART_EV_STATUS_ADDR (CSR_BASE + 0x580cL)
#define CSR_UART_EV_STATUS_SIZE 1

static inline uint32_t uart_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x580cL); }
...
static inline uint32_t uart_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x5810L); }

static inline void uart_ev_pending_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x5810L); }
...
static inline uint32_t uart_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x5814L); }

static inline void uart_ev_enable_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x5814L); }
...
static inline uint32_t uart_txempty_read(void) { return csr_read_simple(CSR_BASE + 0x5818L); }

#define CSR_UART_RXFULL_ADDR (CSR_BASE + 0x581cL)
#define CSR_UART_RXFULL_SIZE 1

static inline uint32_t uart_rxfull_read(void) { return csr_read_simple(CSR_BASE + 0x581cL); }
...
static inline uint32_t uart_enabled_out_read(void) { return csr_read_simple(CSR_BASE + 0x6000L); }

static inline void uart_enabled_out_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x6000L); }
...
static inline uint32_t user_irq_0_in_read(void) { return csr_read_simple(CSR_BASE + 0x6800L); }

#define CSR_USER_IRQ_0_MODE_ADDR (CSR_BASE + 0x6804L)
#define CSR_USER_IRQ_0_MODE_SIZE 1

static inline uint32_t user_irq_0_mode_read(void) { return csr_read_simple(CSR_BASE + 0x6804L); }

static inline void user_irq_0_mode_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x6804L); }

#define CSR_USER_IRQ_0_EDGE_ADDR (CSR_BASE + 0x6808L)
#define CSR_USER_IRQ_0_EDGE_SIZE 1

static inline uint32_t user_irq_0_edge_read(void) { return csr_read_simple(CSR_BASE + 0x6808L); }

static inline void user_irq_0_edge_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x6808L); }

#define CSR_USER_IRQ_0_EV_STATUS_ADDR (CSR_BASE + 0x680cL)
#define CSR_USER_IRQ_0_EV_STATUS_SIZE 1

static inline uint32_t user_irq_0_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x680cL); }
...
static inline uint32_t user_irq_0_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x6810L); }

static inline void user_irq_0_ev_pending_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x6810L); }
...
static inline uint32_t user_irq_0_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x6814L); }

static inline void user_irq_0_ev_enable_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x6814L); }
...
static inline uint32_t user_irq_1_in_read(void) { return csr_read_simple(CSR_BASE + 0x7000L); }

#define CSR_USER_IRQ_1_MODE_ADDR (CSR_BASE + 0x7004L)
#define CSR_USER_IRQ_1_MODE_SIZE 1

static inline uint32_t user_irq_1_mode_read(void) { return csr_read_simple(CSR_BASE + 0x7004L); }

static inline void user_irq_1_mode_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7004L); }

#define CSR_USER_IRQ_1_EDGE_ADDR (CSR_BASE + 0x7008L)
#define CSR_USER_IRQ_1_EDGE_SIZE 1

static inline uint32_t user_irq_1_edge_read(void) { return csr_read_simple(CSR_BASE + 0x7008L); }

static inline void user_irq_1_edge_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7008L); }

#define CSR_USER_IRQ_1_EV_STATUS_ADDR (CSR_BASE + 0x700cL)
#define CSR_USER_IRQ_1_EV_STATUS_SIZE 1

static inline uint32_t user_irq_1_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x700cL); }
...
static inline uint32_t user_irq_1_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x7010L); }

static inline void user_irq_1_ev_pending_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7010L); }
...
static inline uint32_t user_irq_1_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x7014L); }

static inline void user_irq_1_ev_enable_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7014L); }
...
static inline uint32_t user_irq_2_in_read(void) { return csr_read_simple(CSR_BASE + 0x7800L); }

#define CSR_USER_IRQ_2_MODE_ADDR (CSR_BASE + 0x7804L)
#define CSR_USER_IRQ_2_MODE_SIZE 1

static inline uint32_t user_irq_2_mode_read(void) { return csr_read_simple(CSR_BASE + 0x7804L); }

static inline void user_irq_2_mode_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7804L); }

#define CSR_USER_IRQ_2_EDGE_ADDR (CSR_BASE + 0x7808L)
#define CSR_USER_IRQ_2_EDGE_SIZE 1

static inline uint32_t user_irq_2_edge_read(void) { return csr_read_simple(CSR_BASE + 0x7808L); }

static inline void user_irq_2_edge_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7808L); }

#define CSR_USER_IRQ_2_EV_STATUS_ADDR (CSR_BASE + 0x780cL)
#define CSR_USER_IRQ_2_EV_STATUS_SIZE 1

static inline uint32_t user_irq_2_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x780cL); }
...
static inline uint32_t user_irq_2_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x7810L); }

static inline void user_irq_2_ev_pending_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7810L); }
...
static inline uint32_t user_irq_2_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x7814L); }

static inline void user_irq_2_ev_enable_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x7814L); }
...
static inline uint32_t user_irq_3_in_read(void) { return csr_read_simple(CSR_BASE + 0x8000L); }

#define CSR_USER_IRQ_3_MODE_ADDR (CSR_BASE + 0x8004L)
#define CSR_USER_IRQ_3_MODE_SIZE 1

static inline uint32_t user_irq_3_mode_read(void) { return csr_read_simple(CSR_BASE + 0x8004L); }

static inline void user_irq_3_mode_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x8004L); }

#define CSR_USER_IRQ_3_EDGE_ADDR (CSR_BASE + 0x8008L)
#define CSR_USER_IRQ_3_EDGE_SIZE 1

static inline uint32_t user_irq_3_edge_read(void) { return csr_read_simple(CSR_BASE + 0x8008L); }

static inline void user_irq_3_edge_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x8008L); }

#define CSR_USER_IRQ_3_EV_STATUS_ADDR (CSR_BASE + 0x800cL)
#define CSR_USER_IRQ_3_EV_STATUS_SIZE 1

static inline uint32_t user_irq_3_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x800cL); }
...
static inline uint32_t user_irq_3_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x8010L); }
...
static inline uint32_t user_irq_3_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x8014L); }

static inline void user_irq_3_ev_enable_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x8014L); }
...
static inline uint32_t user_irq_4_in_read(void) { return csr_read_simple(CSR_BASE + 0x8800L); }

#define CSR_USER_IRQ_4_MODE_ADDR (CSR_BASE + 0x8804L)
#define CSR_USER_IRQ_4_MODE_SIZE 1

static inline uint32_t user_irq_4_mode_read(void) { return csr_read_simple(CSR_BASE + 0x8804L); }

static inline void user_irq_4_mode_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x8804L); }

#define CSR_USER_IRQ_4_EDGE_ADDR (CSR_BASE + 0x8808L)
#define CSR_USER_IRQ_4_EDGE_SIZE 1

static inline uint32_t user_irq_4_edge_read(void) { return csr_read_simple(CSR_BASE + 0x8808L); }

static inline void user_irq_4_edge_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x8808L); }

#define CSR_USER_IRQ_4_EV_STATUS_ADDR (CSR_BASE + 0x880cL)
#define CSR_USER_IRQ_4_EV_STATUS_SIZE 1

static inline uint32_t user_irq_4_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x880cL); }
...
static inline uint32_t user_irq_4_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x8810L); }

static inline void user_irq_4_ev_pending_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x8810L); }
...
static inline uint32_t user_irq_4_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x8814L); }
...
static inline uint32_t user_irq_5_in_read(void) { return csr_read_simple(CSR_BASE + 0x9000L); }

#define CSR_USER_IRQ_5_MODE_ADDR (CSR_BASE + 0x9004L)
#define CSR_USER_IRQ_5_MODE_SIZE 1

static inline uint32_t user_irq_5_mode_read(void) { return csr_read_simple(CSR_BASE + 0x9004L); }

static inline void user_irq_5_mode_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x9004L); }

#define CSR_USER_IRQ_5_EDGE_ADDR (CSR_BASE + 0x9008L)
#define CSR_USER_IRQ_5_EDGE_SIZE 1

static inline uint32_t user_irq_5_edge_read(void) { return csr_read_simple(CSR_BASE + 0x9008L); }

static inline void user_irq_5_edge_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x9008L); }

#define CSR_USER_IRQ_5_EV_STATUS_ADDR (CSR_BASE + 0x900cL)
#define CSR_USER_IRQ_5_EV_STATUS_SIZE 1

static inline uint32_t user_irq_5_ev_status_read(void) { return csr_read_simple(CSR_BASE + 0x900cL); }
...
static inline uint32_t user_irq_5_ev_pending_read(void) { return csr_read_simple(CSR_BASE + 0x9010L); }

static inline void user_irq_5_ev_pending_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x9010L); }
...
static inline uint32_t user_irq_5_ev_enable_read(void) { return csr_read_simple(CSR_BASE + 0x9014L); }

static inline void user_irq_5_ev_enable_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x9014L); }
...
static inline uint32_t user_irq_ena_out_read(void) { return csr_read_simple(CSR_BASE + 0x9800L); }

static inline void user_irq_ena_out_write(uint32_t v) { csr_write_simple(v, CSR_BASE + 0x9800L); }
