...
static inline void csr_write_simple(unsigned long v, unsigned long a) { MMPTR(a) = v; }

static inline unsigned long csr_read_simple(unsigned long a) { return MMPTR(a); }
 ...
 *  |  8  | 1 1 1 1 1 1 1 1 |
 *  +-----+-----------------+ */
static inline int num_subregs(int csr_bytes) { return (csr_bytes - 1) / CSR_DW_BYTES + 1; }
...
static inline uint8_t csr_rd_uint8(unsigned long a) { return _csr_rd(a, sizeof(uint8_t)); }

static inline void csr_wr_uint8(uint8_t v, unsigned long a) { _csr_wr(a, v, sizeof(uint8_t)); }

static inline uint16_t csr_rd_uint16(unsigned long a) { return _csr_rd(a, sizeof(uint16_t)); }

static inline void csr_wr_uint16(uint16_t v, unsigned long a) { _csr_wr(a, v, sizeof(uint16_t)); }

static inline uint32_t csr_rd_uint32(unsigned long a) { return _csr_rd(a, sizeof(uint32_t)); }

static inline void csr_wr_uint32(uint32_t v, unsigned long a) { _csr_wr(a, v, sizeof(uint32_t)); }

static inline uint64_t csr_rd_uint64(unsigned long a) { return _csr_rd(a, sizeof(uint64_t)); }

static inline void csr_wr_uint64(uint64_t v, unsigned long a) { _csr_wr(a, v, sizeof(uint64_t)); }
...
static inline void csr_rd_buf_uint8(unsigned long a, uint8_t* buf, int cnt) { _csr_rd_buf(a, buf, cnt); }

static inline void csr_wr_buf_uint8(unsigned long a, const uint8_t* buf, int cnt) { _csr_wr_buf(a, buf, cnt); }

static inline void csr_rd_buf_uint16(unsigned long a, uint16_t* buf, int cnt) { _csr_rd_buf(a, buf, cnt); }

static inline void csr_wr_buf_uint16(unsigned long a, const uint16_t* buf, int cnt) { _csr_wr_buf(a, buf, cnt); }

static inline void csr_rd_buf_uint32(unsigned long a, uint32_t* buf, int cnt) { _csr_rd_buf(a, buf, cnt); }

static inline void csr_wr_buf_uint32(unsigned long a, const uint32_t* buf, int cnt) { _csr_wr_buf(a, buf, cnt); }
...
static inline void csr_rd_buf_uint64(unsigned long a, uint64_t* buf, int cnt) { _csr_rd_buf(a, buf, cnt); }

static inline void csr_wr_buf_uint64(unsigned long a, const uint64_t* buf, int cnt) { _csr_wr_buf(a, buf, cnt); }
