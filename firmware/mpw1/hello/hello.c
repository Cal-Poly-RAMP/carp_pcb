...
void set_gpio(int pin) { (volatile uint32_t)((reg_mprj_datal) |= pin); }

void clear_gpio(int pin) { (volatile uint32_t)((reg_mprj_datal) &= ~(pin)); }
...
void main() {
  ...
  char* msg[] = {
      //  "******************* ",
      " Woowzaaa!!         ", "                    ", " I'm Caravel !!     ", "      I'm Alive !!! ",
      //  "******************* ",
  };
